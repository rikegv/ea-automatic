...
/**
 * DTOs DO GERENCIADOR DE SEGMENTOS (A&S, Onda E).
 *
 ...
 *
 * §A.6: nenhum campo aqui carrega dado pessoal. Segmento é o RAMO do cliente (Varejo, Saúde,
 * Indústria), não a segmentação de ÁREA do RBAC, e não tem nada a ver com ela.
 */
...
/** Renomear. O código NÃO muda (ver o cabeçalho): é o MESMO segmento, com o nome corrigido. */
export class RenomearSegmentoDto {
  @Transform(({ value }) => (typeof value === "string" ? value.trim() : value))
  @IsString()
  @MinLength(2)
  @MaxLength(120)
 ...
 */
export class ReordenarSegmentosDto {
  @IsArray()
  @ArrayMinSize(1)
  @ArrayMaxSize(200)
  @IsInt({ each: true })
